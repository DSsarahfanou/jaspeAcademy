    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <div class="flex items-center gap-5">
            ...
            <button @click="editMode = !editMode"
                ...
                <span x-text="editMode ? 'Annuler' : 'Modifier'">Modifier</span>
            </button>
        </div>
    </div>

    {{-- Info / Formulaire --}}
    <form method="POST" action="{{ route('apprenant.profil.update') }}"
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                ...
                <input type="email" value="{{ $user->email }}" disabled
                       class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm bg-gray-50 text-gray-500">
        ...
        <div x-show="editMode" x-cloak
            ...
            <button type="button" @click="editMode = false"
                    class="px-5 py-2.5 rounded-xl border-2 border-gray-200 text-gray-600 text-sm font-semibold
